...
func TestCompareAllPricePlansWithInvalidSmartMeterID(t *testing.T) {
	t.Parallel()
	...
	plans, err := service.CompareAllPricePlans("smartMeterId")

	assert.Equal(t, domain.PricePlanComparisons{}, plans)
	assert.Error(t, err)
}
